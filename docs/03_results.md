...
| **Buckner & Krienen 2013** (TICS) | Negative control — is π sparsest over untethered association cortex? | sensorimotor−association coverage gap **6.6 log units** (p = 6×10⁻⁷, empirical p = 0.000) | **Pass (negative control)** |
