...
- **Calibrated & honest** — π carries a multi-source trust tier, and we evaluate with spin / translation-spin nulls and report held-out (not just supervised) numbers.
