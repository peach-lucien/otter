...
That fit is what most downstream queries should use. The individual pack runners in `experiments/anchor_packs/` produce per-pack variants for ablation / inspection.
