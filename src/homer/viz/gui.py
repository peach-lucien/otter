"""Region-first static GUI for exploring HOMER couplings.
...
from homer.viz.viewer import col_entropy, row_entropy, topk_per_col, topk_per_row
    ...
    *,
    ...
    if mask_path.exists():
        try:
            ...
            from homer.data.anchor_packs._dsurqe import DSURQE_OFFSET_MM
...
<title>HOMER Mapping Explorer</title>
...
function exportQuery(){
  ...
  a.href = url; a.download = 'homer_query.json'; a.click();
